...
public class App {
    ...
    public static void main(String[] args) throws DAOException, SQLException {
        ...
        LOG.info("3.Jaxb parse");
        LOG.info("4.Jackson parse");
        Scanner scoptiondriver = new Scanner(System.in);
        int optiondriver = scoptiondriver.nextInt();
        switch (optiondriver) {
            case 1:
                ...
                switch (option) {
                    ...
                    case 3:
                        ...
                        int medicsopt = scmedics.nextInt();
                        switch (medicsopt) {
                            case 1:
                                try (Connection conn = ConnectionPool.getInstance().getConnection()) {
                    ...
                    case 4:
                        ...
                        int prescriptionopt = scprescription.nextInt();
                    ...
                    case 5:
                        ...
                        int nursesopt = scnurses.nextInt();
                        switch (nursesopt) {
                            case 1:
                                try (Connection conn = ConnectionPool.getInstance().getConnection()) {
            ...
            case 3:
                LOG.info("Select an option to do. \n 1. Unmarshall\n 2. Marshall");
                Scanner scjaxb = new Scanner(System.in);
                int jaxbopt = scjaxb.nextInt();
                switch (jaxbopt) {
                    case 1:
                        Jaxb jb = new Jaxb();
                        Prescription prescription1 = jb.unmarshall(Constants.JAXB);
                        LOG.info(prescription1);
                        break;
                    case 2:
                        Jaxb jxb = new Jaxb();
                        Prescription newPrescription = new Prescription();
                        newPrescription.setPrescriptionID(5);
                        newPrescription.setPrescriptionPrice(300);
                        newPrescription.setMedicId(2);
                        newPrescription.setPatientId(1);
                        jxb.marshall(newPrescription, "src/main/resources/newPrescription.xml");
                        break;
                    default:
                        LOG.error("Enter a valid option");
                        break;
                }
            case 4:
                LOG.info("Json utils ");
                ...
                try {
                    JavaType ntype = om.getTypeFactory().constructCollectionType(List.class, HealthCare.class);
                    List healthcare = om.readValue(new File(Constants.JSON), ntype);
                    LOG.info(healthcare);
